...
CREATE TABLE `RESTRICTIONS_ROLES` (
	`RR_ID` int NOT NULL AUTO_INCREMENT UNIQUE,
	`RR_MC_ID` int NOT NULL,
	PRIMARY KEY (`RR_ID`)
);

CREATE TABLE `RESTRICTION_ROLE_ITEMS` (
	`RI_ID` int NOT NULL AUTO_INCREMENT,
	`RI_RR_ID` int NOT NULL,
...
ALTER TABLE `RESTRICTIONS_ROLES` ADD CONSTRAINT `RESTRICTIONS_ROLES_fk0` FOREIGN KEY (`RR_MC_ID`) REFERENCES `MENU_COLLECTION`(`MC_ID`);
...
ALTER TABLE `RESTRICTION_ROLE_ITEMS` ADD CONSTRAINT `RESTRICTION_ROLE_ITEMS_fk1` FOREIGN KEY (`RI_RR_ID`) REFERENCES `RESTRICTIONS_ROLES`(`RR_ID`);


ALTER TABLE `MENU_ITEM` ADD CONSTRAINT `MENU_ITEM_fk0` FOREIGN KEY (`MI_MC_ID`) REFERENCES `MENU_COLLECTION`(`MC_ID`);

ALTER TABLE `MENU_ITEM` ADD CONSTRAINT `MENU_ITEM_fk1` FOREIGN KEY (`MI_RESTRICTION_ID`) REFERENCES `RESTRICTIONS_ROLES`(`RR_ID`);
